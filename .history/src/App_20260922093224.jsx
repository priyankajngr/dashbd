...
function App() {
  ...
  const filteredEmployees = useMemo(() => {
    return employees.filter((employee) => {
      const matchesDepartment =
        ...
        console.log("matchesDepartment", matchesDepartment, department, employee.department);

      const matchesStatus =
        status === "All" ||
        (status === "Active" && employee.isActive) ||
        (status === "Inactive" && !employee.isActive);
        console.log("matchesStatus", matchesStatus, status, employee.isActive);
      ...
      const matchesSearch =
        ...
        console.log("matchesSearch", matchesSearch, search, employee.firstName, employee.lastName, employee.position, employee.department, employee.location);
  ...
  const departmentsCount = departments.length - 1; 

  console.log("activeEmployees", activeEmployees);
  console.log("departmentsCount", departmentsCount);
