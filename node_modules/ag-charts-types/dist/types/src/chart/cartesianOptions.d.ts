...
import type { AgAxisBaseIntervalOptions, AgAxisBaseTickOptions, AgAxisContinuousIntervalOptions, AgAxisLabelStylerParams, AgBaseAxisLabelOptions, AgBaseAxisLabelStyleOptions, AgBaseAxisOptions, AgBaseContinuousAxisOptions, AgCartesianAxisCaptionOptions, AgContinuousAxisOptions, AgNumericAxisFormattableLabelOptions, AgTimeAxisFormattableLabelFormat, AgTimeAxisFormattableLabelOptions, AgTimeInterval, AgTimeIntervalUnit } from './axisOptions';
...
import type { AxisValue, ContextDefault, DatumDefault, Degree, FontFamilyFull, PixelSize, Ratio, TextWrap } from './types';
...
export type AgCartesianCrossLineOptions<TValue = AxisValue, TContext = ContextDefault> = AgBaseCrossLineOptions<TValue, AgCartesianCrossLineLabelOptions, TContext>;
 ...
 * information there.
 */
export type AgSeriesAreaBackgroundRegionLabelPosition = 'top' | 'left' | 'right' | 'bottom' | 'left-top' | 'right-top' | 'left-bottom' | 'right-bottom' | 'inside' | 'inside-left' | 'inside-right' | 'inside-top' | 'inside-bottom' | 'inside-top-left' | 'inside-bottom-left' | 'inside-top-right' | 'inside-bottom-right' | 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right';
export {};
