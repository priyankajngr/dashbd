 ...
 */
export type AgChartLabelCollisionPlacement = 'inside' | 'top' | 'bottom' | 'left' | 'right' | 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right';
 ...
 */
export type AgBarSeriesLabelPlacement = 'inside-center' | 'inside-start' | 'inside-end' | 'outside-start' | 'outside-end' | 'beside-before-start' | 'beside-before-center' | 'beside-before-end' | 'beside-after-start' | 'beside-after-center' | 'beside-after-end';
/**
 ...
 */
export type AgFunnelSeriesLabelPlacement = 'inside-center' | 'inside-start' | 'inside-end' | 'inside-before' | 'inside-after' | 'outside-start' | 'outside-end' | 'outside-before' | 'outside-after';
/**
 ...
 */
export type AgConeFunnelSeriesLabelPlacement = 'start-before' | 'start-center' | 'start-after' | 'middle-before' | 'middle-center' | 'middle-after' | 'end-before' | 'end-center' | 'end-after';
