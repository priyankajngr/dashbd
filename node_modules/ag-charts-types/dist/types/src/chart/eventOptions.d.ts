...
export interface AgBaseNodeClickEvent<TEvent extends string, TDatum, TContext = ContextDefault> extends AgChartEvent<TEvent, TContext>, AgPreventableEvent, AgCoordinatedEvent, Omit<AgNodeClickParams<TDatum>, 'type'> {
    /** Event type. */
    type: TEvent;
}
export interface AgNodeClickEvent<TEvent extends string, TDatum, TContext = ContextDefault> extends AgBaseNodeClickEvent<TEvent, TDatum, TContext> {
...
export interface AgChartClickEvent<TContext = ContextDefault> extends AgChartEvent<'click', TContext>, Partial<AgCoordinatedEvent> {
}
export interface AgChartDoubleClickEvent<TContext = ContextDefault> extends AgChartEvent<'doubleClick', TContext>, Partial<AgCoordinatedEvent> {
}
export interface AgChartContextMenuEvent<TContext = ContextDefault> extends AgChartEvent<'contextMenuEvent', TContext>, Partial<AgCoordinatedEvent> {
}
export interface AgSeriesAreaContextMenuActionEvent<TContext = ContextDefault> extends AgChartEvent<'seriesContextMenuAction', TContext>, AgCoordinatedEvent {
}
export type AgCaptionType = 'title' | 'subtitle' | 'footnote';
export interface AgAxisContextMenuActionEvent<TContext = ContextDefault> extends AgChartEvent<'axisContextMenuAction', TContext>, AgAxisCoordinate {
    /** Axis ID, as specified in `axes`. */
    axisId: string;
}
export interface AgAxisClickEvent<TEvent extends string, TContext = ContextDefault> extends AgChartEvent<TEvent, TContext>, AgAxisCoordinate {
...
export interface AgCrossLineContextMenuActionEvent<TContext = ContextDefault> extends AgChartEvent<'crossLineContextMenuAction', TContext>, Omit<AgCrossLineClickParams, 'type'>, AgCoordinatedEvent {
}
export interface AgCrossLineClickEvent<TContext = ContextDefault> extends AgChartEvent<'crossLineClick', TContext>, Omit<AgCrossLineClickParams, 'type'>, AgAllCrossLineClickParams {
}
export interface AgCrossLineDoubleClickEvent<TContext = ContextDefault> extends AgChartEvent<'crossLineDoubleClick', TContext>, Omit<AgCrossLineClickParams, 'type'>, AgAllCrossLineClickParams {
}
export interface AgCaptionContextMenuActionEvent<TContext = ContextDefault> extends AgChartEvent<'captionContextMenuAction', TContext> {
    /** Which type of caption was clicked on. */
    captionType: AgCaptionType;
    /** The text of the clicked caption. */
    text: TextOrSegments;
}
export interface AgCaptionClickEvent<TEvent extends string, TContext = ContextDefault> extends AgChartEvent<TEvent, TContext> {
