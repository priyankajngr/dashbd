...
type ThemeParam = keyof AgChartAllThemeParams | 'buttonBorder.color' | 'buttonBorder.width' | 'inputBorder.color' | 'inputBorder.width' | 'menuBorder.color' | 'menuBorder.width' | 'tooltipBorder.color' | 'tooltipBorder.width';
...
type LocationOperation = {
    ...
    $isUserOption: Leaf<string> | [UserOptionTarget] | [UserOptionTarget, AnyLeaf] | [UserOptionTarget, AnyLeaf, AnyLeaf];
} | {
...
type LogicOperation = {
    ...
    $isType: [AnyLeaf, ValueTypeName | ValueTypeName[]] | [AnyLeaf, ValueTypeName | ValueTypeName[], AnyLeaf | object] | [AnyLeaf, ValueTypeName | ValueTypeName[], AnyLeaf | object, AnyLeaf | object];
} | {
    $or: AnyLeaf[];
} | {
    $and: AnyLeaf[];
