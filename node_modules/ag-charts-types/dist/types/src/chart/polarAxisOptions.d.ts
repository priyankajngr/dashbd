...
export interface AgAngleNumberAxisOptions<TContext = ContextDefault> extends Omit<AgBaseAxisOptions<AgAngleAxisFormattableLabelOptions<TContext>, TContext>, 'interval'>, AgContinuousAxisOptions<AgNumericValue, AgNumericValue> {
    type?: 'angle-number';
    /** Angle in degrees to start ticks positioning from. */
    startAngle?: Degree;
...
export type AgAngleCrossLineOptions<TValue = AxisValue> = AgBaseCrossLineOptions<TValue, AgBaseCrossLineLabelOptions, ContextDefault>;
