...
export interface AgRadiusNumberAxisOptions<TContext = ContextDefault> extends Omit<AgBaseAxisOptions<AgRadiusAxisFormattableLabelOptions<TContext>, TContext>, 'interval'>, AgContinuousAxisOptions<AgNumericValue, AgNumericValue> {
    type?: 'radius-number';
...
export type AgRadiusCrossLineOptions<TValue = AxisValue> = AgBaseCrossLineOptions<TValue, AgRadiusCrossLineLabelOptions, ContextDefault>;
