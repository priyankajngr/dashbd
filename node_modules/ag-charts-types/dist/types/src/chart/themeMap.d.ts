...
export type ExtensibleSeriesTheme<SType extends SeriesType, TDatum = DatumDefault, TContext = ContextDefault> = WithThemeParams<NonNullable<ThemesMap<TDatum, TContext>[SType]>>;
export type ExtensibleTheme<TDatum = DatumDefault, TContext = ContextDefault> = WithThemeParams<NonNullable<ThemesMap<TDatum, TContext>>>;
export {};
