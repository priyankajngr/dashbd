...
export type AgBaseFinancialPresetOptions<TDatum = DatumDefault> = Pick<AgCartesianChartOptions<TDatum, never>, 'container' | 'width' | 'height' | 'minWidth' | 'minHeight' | 'theme' | 'title' | 'initialState' | 'data' | 'dataIdKey' | 'dataSource' | 'listeners' | 'formatter' | 'enableRtl'>;
...
export type AgBaseQuadrantChartOptions<TDatum = DatumDefault, TContext = ContextDefault> = Pick<AgCartesianChartOptions<TDatum, TContext>, 'animation' | 'container' | 'contextMenu' | 'data' | 'dataIdKey' | 'enableRtl' | 'footnote' | 'formatter' | 'initialState' | 'height' | 'listeners' | 'locale' | 'minWidth' | 'minHeight' | 'padding' | 'subtitle' | 'title' | 'theme' | 'selection' | 'width'>;
export type AgQuadrantChartOptions<TDatum = DatumDefault, TContext = ContextDefault> = AgBaseQuadrantChartOptions<TDatum, TContext> & AgQuadrantChartPresets<TDatum, TContext>;
export type AgPresetOptions<TDatum = DatumDefault, TContext = ContextDefault> = AgFinancialChartOptions<TDatum> | AgGaugeOptions<TDatum, TContext> | AgSparklineOptions<TDatum, TContext> | AgQuadrantChartOptions<TDatum, TContext>;
