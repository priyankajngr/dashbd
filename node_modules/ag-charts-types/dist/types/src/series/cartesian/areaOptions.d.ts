import type { ContextCallbackParams, HighlightState, SelectionState, SeriesCallbackParams, Styler } from '../../chart/callbackOptions';
...
export interface AgAreaSeriesLabelOptions<TDatum, TParams, TContext = ContextDefault> extends AgChartLabelOptions<TDatum, TParams, TContext>, AgChartLabelCollisionFitOptions, AgChartLabelAutoFontSizeOptions, AgSeriesLabelPlacementStyleOptions {
    /**
...
export interface AgAreaSeriesStylerParams<TDatum, TContext> extends AgAreaSeriesOptionsKeys<TDatum>, SeriesCallbackParams<HighlightState, SelectionState>, ContextCallbackParams<TContext>, Required<StrokeOptions>, Required<FillOptions>, Required<LineDashOptions> {
...
export interface AgAreaSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseSeriesOptions<TDatum, TContext>, 'highlight'>, AgBaseCartesianSeriesAxisOptions, AgAreaSeriesOptionsKeys<TDatum>, AgAreaSeriesOptionsNames, AgAreaSeriesThemeableOptions<TDatum, TContext> {
