...
export interface AgBarSeriesLabelOptions<TDatum, TParams, TContext = ContextDefault> extends AgChartLabelOptions<TDatum, TParams, TContext>, AgChartLabelCollisionFitOptions, AgChartLabelAutoFontSizeOptions, AgSeriesLabelPlacementStyleOptions {
    /**
...
export interface AgBarSeriesItemStylerParams<TDatum, TContext = ContextDefault> extends DatumCallbackParams<TDatum, HighlightState>, ContextCallbackParams<TContext>, AgBarSeriesOptionsKeys<TDatum>, Required<AgBarSeriesStyle> {
...
export interface AgBarSeriesStylerParams<TDatum, TContext> extends SeriesCallbackParams<HighlightState, SelectionState>, ContextCallbackParams<TContext>, AgBarSeriesOptionsKeys<TDatum>, Required<AgBarSeriesStyle> {
    readonly stackGroup?: string;
}
...
export interface AgBarSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseSeriesOptions<TDatum, TContext>, 'highlight'>, AgBaseCartesianSeriesAxisOptions, AgBarSeriesOptionsKeys<TDatum>, AgBarSeriesOptionsNames, AgBarSeriesThemeableOptions<TDatum, TContext> {
