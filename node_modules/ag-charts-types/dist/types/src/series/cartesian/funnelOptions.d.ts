...
import type { AgChartLabelCollisionFitOptions, AgChartLabelOptions, AgSeriesLabelPlacementStyleOptions } from '../../chart/labelOptions';
...
export interface AgFunnelSeriesLabelOptions<TDatum, TParams, TContext = ContextDefault> extends AgChartLabelOptions<TDatum, TParams, TContext>, AgChartLabelCollisionFitOptions, AgSeriesLabelPlacementStyleOptions {
    /**
...
export interface AgFunnelSeriesItemStylerParams<TDatum = DatumDefault, TContext = ContextDefault> extends DatumCallbackParams<TDatum, HighlightState>, ContextCallbackParams<TContext>, AgFunnelSeriesOptionsKeys<TDatum>, Required<AgFunnelSeriesStyle> {
}
...
export interface AgFunnelSeriesThemeableOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseCartesianThemeableOptions<TDatum, TContext>, 'showInLegend' | 'showInMiniChart' | 'selection'>, LineDashOptions {
...
export interface AgFunnelSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseSeriesOptions<TDatum, TContext>, 'showInLegend' | 'selection'>, AgFunnelSeriesOptionsKeys<TDatum>, AgFunnelSeriesOptionsNames, AgFunnelSeriesThemeableOptions<TDatum, TContext> {
