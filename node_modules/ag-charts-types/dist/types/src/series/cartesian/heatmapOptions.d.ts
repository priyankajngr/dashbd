...
import type { AgChartAutoSizedSecondaryLabelOptions, AgChartLabelStyleOptions, AgChartLabelStylerParams } from '../../chart/labelOptions';
...
export type AgHeatmapSeriesItemStylerParams<TDatum = DatumDefault, TContext = ContextDefault> = DatumCallbackParams<TDatum, HighlightState> & ContextCallbackParams<TContext> & AgHeatmapSeriesOptionsKeys<TDatum> & Required<AgHeatmapSeriesStyle>;
...
export interface AgHeatmapSeriesLabelOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgChartAutoSizedSecondaryLabelOptions<TDatum, AgHeatmapSeriesLabelFormatterParams<TDatum>, TContext>, 'itemStyler'> {
    /** Horizontal position of the label within the cell.
     *
     * Default: `center`
     */
    ...
    itemStyler?: Styler<AgChartLabelStylerParams<TDatum, TContext> & AgHeatmapSeriesLabelFormatterParams<TDatum>, AgHeatmapSeriesLabelStyle>;
}
...
export interface AgHeatmapSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseSeriesOptions<TDatum, TContext>, 'showInLegend'>, AgBaseCartesianSeriesAxisOptions, AgHeatmapSeriesOptionsKeys<TDatum>, AgHeatmapSeriesOptionsNames, AgHeatmapSeriesThemeableOptions<TDatum, TContext> {
