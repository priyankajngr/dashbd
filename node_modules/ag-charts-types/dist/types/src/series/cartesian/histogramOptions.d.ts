...
export type AgHistogramSeriesLabelPlacement = 'inside-center' | 'inside-start' | 'inside-end' | 'outside-start' | 'outside-end';
export interface AgHistogramSeriesLabelOptions<TDatum, TParams, TContext = ContextDefault> extends AgChartLabelOptions<TDatum, TParams, TContext>, AgChartLabelCollisionFitOptions, AgChartLabelAutoFontSizeOptions, AgSeriesLabelPlacementStyleOptions {
    /**
...
interface AgBaseHistogramClickEvent<TType extends string, TDatum, TContext> extends Omit<AgNodeClickEvent<TType, TDatum, TContext>, keyof AgHistogramSeriesBinParams<TDatum>>, AgHistogramSeriesBinParams<TDatum> {
}
/** Node click/double-click event fired for a histogram bin. */
export interface AgHistogramSeriesNodeClickEvent<TDatum = DatumDefault, TContext = ContextDefault> extends AgBaseHistogramClickEvent<'seriesNodeClick', TDatum, TContext> {
}
export interface AgHistogramSeriesNodeDoubleClickEvent<TDatum = DatumDefault, TContext = ContextDefault> extends AgBaseHistogramClickEvent<'seriesNodeDoubleClick', TDatum, TContext> {
}
