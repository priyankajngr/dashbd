...
export interface AgLineSeriesLabelOptions<TDatum, TParams, TContext = ContextDefault> extends AgChartLabelOptions<TDatum, TParams, TContext>, AgChartLabelCollisionFitOptions, AgChartLabelAutoFontSizeOptions, AgSeriesLabelPlacementStyleOptions {
    /**
...
export interface AgLineSeriesStylerParams<TDatum, TContext> extends AgLineSeriesOptionsKeys<TDatum>, SeriesCallbackParams<HighlightState, SelectionState>, ContextCallbackParams<TContext>, Required<StrokeOptions>, Required<LineDashOptions> {
...
export interface AgLineSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseSeriesOptions<TDatum, TContext>, 'highlight'>, AgBaseCartesianSeriesAxisOptions, AgLineSeriesOptionsKeys<TDatum>, AgLineSeriesOptionsNames, AgLineSeriesThemeableOptions<TDatum, TContext> {
