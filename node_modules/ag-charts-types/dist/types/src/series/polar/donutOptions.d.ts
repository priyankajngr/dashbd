...
import type { AgColorType, FillOptions, LineDashOptions, StrokeOptions, TextOptions, TextOrSegments, Toggleable } from '../cartesian/commonOptions';
...
export interface AgDonutSeriesLabelOptions<TDatum, TParams, TContext = ContextDefault> extends AgChartLabelOptions<TDatum, TParams, TContext>, AgChartLabelFitOptions, AgChartLabelAutoFontSizeOptions {
...
export interface AgDonutSeriesSectorLabelOptions<TDatum, TParams, TContext = ContextDefault> extends AgChartLabelOptions<TDatum, TParams, TContext>, AgChartLabelFitOptions, AgChartLabelAutoFontSizeOptions {
...
export type AgDonutSeriesItemStylerParams<TDatum = DatumDefault, TContext = ContextDefault> = DatumCallbackParams<TDatum, HighlightState> & ContextCallbackParams<TContext> & AgDonutSeriesOptionsKeys<TDatum> & Required<AgDonutSeriesStyle>;
...
export interface AgDonutCalloutLineItemStylerParams<TDatum, TContext> extends DatumCallbackParams<TDatum, HighlightState>, ContextCallbackParams<TContext>, AgDonutSeriesLabelFormatterParams<TDatum> {
}
