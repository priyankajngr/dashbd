...
import type { AgChartLabelAutoFontSizeOptions, AgChartLabelFitOptions, AgChartLabelOptions } from '../../chart/labelOptions';
...
import type { AgColorType, FillOptions, LineDashOptions, StrokeOptions, TextOptions, Toggleable } from '../cartesian/commonOptions';
...
export interface AgPieSeriesLabelOptions<TDatum, TParams, TContext = ContextDefault> extends AgChartLabelOptions<TDatum, TParams, TContext>, AgChartLabelFitOptions, AgChartLabelAutoFontSizeOptions {
...
export interface AgPieSeriesSectorLabelOptions<TDatum, TParams, TContext = ContextDefault> extends AgChartLabelOptions<TDatum, TParams, TContext>, AgChartLabelFitOptions, AgChartLabelAutoFontSizeOptions {
...
export type AgPieSeriesItemStylerParams<TDatum = DatumDefault, TContext = ContextDefault> = DatumCallbackParams<TDatum, HighlightState> & ContextCallbackParams<TContext> & AgPieSeriesOptionsKeys<TDatum> & Required<AgPieSeriesStyle>;
...
export interface AgPieCalloutLineItemStylerParams<TDatum, TContext> extends DatumCallbackParams<TDatum, HighlightState>, ContextCallbackParams<TContext>, AgPieSeriesLabelFormatterParams<TDatum> {
}
...
export interface AgPieSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgPieSeriesThemeableOptions<TDatum, TContext>, 'innerLabels'>, AgPieSeriesOptionsKeys<TDatum>, AgPieSeriesOptionsNames, Omit<AgBaseSeriesOptions<TDatum, TContext>, 'highlight' | 'selection'> {
