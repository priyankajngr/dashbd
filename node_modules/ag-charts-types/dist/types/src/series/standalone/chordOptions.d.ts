...
export interface AgChordSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseSeriesOptions<TDatum, TContext>, 'selection'>, AgChordSeriesOptionsKeys, AgChordSeriesOptionsNames, AgChordSeriesThemeableOptions<TDatum, TContext> {
...
export interface AgChordSeriesGetItemIdParams<TDatum = DatumDefault, TContext = ContextDefault> extends ContextCallbackParams<TContext> {
...
export interface AgChordSeriesLinkItemStylerParams<TDatum, TContext = ContextDefault> extends DatumCallbackParams<TDatum, HighlightState>, ContextCallbackParams<TContext>, AgChordSeriesOptionsKeys, Required<AgChordSeriesLinkStyle> {
}
export interface AgChordSeriesNodeItemStylerParams<TDatum, TContext = ContextDefault> extends DatumCallbackParams<TDatum, HighlightState>, ContextCallbackParams<TContext>, AgChordSeriesOptionsKeys, Required<AgChordSeriesNodeStyle> {
    /** Label of the node. */
    label: string | undefined;
    /** Size of the node. */
    size: number;
}
export interface AgChordSeriesThemeableOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseSeriesThemeableOptions<TDatum, TContext>, 'selection'> {
