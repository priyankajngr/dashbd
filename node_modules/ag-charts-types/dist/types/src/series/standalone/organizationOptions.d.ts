...
import type { ContextDefault, DatumDefault, FontWeight, Opacity, OverflowStrategy, PixelSize, TextAlign, TextWrap } from '../../chart/types';
...
export interface AgOrganizationSeriesThemeableOptions<TDatum = DatumDefault, TContext = ContextDefault> extends AgBaseSeriesThemeableOptions<TDatum, TContext>, Omit<AgNetworkSeriesTreeLayout, 'direction'> {
    /**
...
export interface AgOrganizationSeriesOptionsExpanderText<TDatum = DatumDefault, TContext = ContextDefault> extends AgOrganizationSeriesExpanderTextStyle {
