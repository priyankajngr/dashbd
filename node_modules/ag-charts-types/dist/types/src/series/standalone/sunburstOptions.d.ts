import type { ContextCallbackParams, DatumCallbackParams, HierarchyHighlightState, Styler } from '../../chart/callbackOptions';
...
import type { AgColorScale, AgColorType, FillOptions, StrokeOptions, TextOptions, TextOrSegments } from '../cartesian/commonOptions';
...
export interface AgSunburstSeriesThemeableOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseSeriesThemeableOptions<TDatum, TContext>, 'highlight' | 'showInLegend'> {
...
export interface AgSunburstSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseSeriesOptions<TDatum, TContext>, 'highlight' | 'highlightStyle' | 'showInLegend' | 'selection'>, AgSunburstSeriesOptionsKeys, AgSunburstSeriesOptionsNames, Omit<AgSunburstSeriesThemeableOptions<TDatum, TContext>, 'innerLabels'> {
...
export interface AgSunburstSeriesItemStylerParams<TDatum, TContext = ContextDefault> extends DatumCallbackParams<TDatum, AgSunburstHighlightState>, ContextCallbackParams<TContext>, AgSunburstSeriesOptionsKeys, Required<AgSunburstSeriesStyle> {
    /** The depth of the datum in the hierarchy. */
    depth: number;
}
