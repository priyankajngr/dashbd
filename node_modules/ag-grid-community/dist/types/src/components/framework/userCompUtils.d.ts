...
export declare function _getTooltipCompDetails(userCompFactory: UserComponentFactory, params: ITooltipParams, def?: ColDef | ColGroupDef): UserCompDetails<ITooltipComp> | undefined;
/**
