...
export declare class EditService extends BeanStub implements NamedBean {
    ...
    private editorAttachValidationCache;
    /** Covers framework editors that attach after `_setupEditor` returns. */
    private readonly pendingEditorAttachValidation;
    ...
    stopEditing(position?: EditPosition, params?: StopEditParams, validationCache?: EditorValidationCache): boolean;
    ...
    closeCellEditor(position: Required<EditPosition>, validationCache?: EditorValidationCache): void;
    /**
     ...
     */
    revertCellEdit(position: Required<EditPosition>, validationCache?: EditorValidationCache): void;
    ...
    checkNavWithValidationAndCache(position?: EditPosition, event?: Event | CellFocusedEvent, focus?: boolean): {
        result: EditNavOnValidationResult;
     ...
     */
    withEditorAttachValidationCache(validationCache: EditorValidationCache | undefined, cellCtrl: CellCtrl, action: () => void): EditorValidationCache | undefined;
    /** Calls through to standalone method for treeshaking via the editService */
    populateModelValidationErrors(cellCtrl?: CellCtrl): void;
    /** The editor request was cancelled or recycled before it could consume its validation hand-off. */
    clearPendingEditorAttachValidation(cellCtrl: CellCtrl): void;
    /** Same-row Tab must not schedule a second editor while the restored editor is still attaching. */
    hasPendingEditorAttachValidation(cellCtrl: CellCtrl): boolean;
    announceFullRowEditValidationErrors(rowNode?: IRowNode): void;
    /**
