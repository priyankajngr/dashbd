...
export declare abstract class BaseEditStrategy extends BeanStub {
    ...
    abstract moveToNextEditingCell(previousCell: CellCtrl, backwards: boolean, event?: KeyboardEvent, source?: EditSource, preventNavigation?: boolean, validationCache?: EditorValidationCache): boolean | null;
    stopCancelled(forceCancel: boolean, validationCache?: EditorValidationCache): boolean;
    stopCommitted(event: Event | null, commit: boolean, validationCache?: EditorValidationCache): boolean;
    protected abstract processValidationResults(results: EditValidationResult): EditValidationAction;
    cleanupEditors({ rowNode }?: EditRowPosition, includeEditing?: boolean, validationCache?: EditorValidationCache): void;
    ...
    focusFirstInvalidCell(cell: CellCtrl, event?: KeyboardEvent): void;
    ...
    abstract releaseRows(rowNodes: Set<IRowNode>): void;
