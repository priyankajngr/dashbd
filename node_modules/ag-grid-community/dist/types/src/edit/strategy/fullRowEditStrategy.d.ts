...
export declare class FullRowEditStrategy extends BaseEditStrategy {
    ...
    releaseRows(rowNodes: Set<IRowNode>): void;
    cleanupEditors(position?: EditRowPosition, includeEditing?: boolean, validationCache?: EditorValidationCache): void;
    /**
    ...
    moveToNextEditingCell(prevCell: CellCtrl, backwards: boolean, event?: KeyboardEvent, source?: 'api' | 'ui', preventNavigation?: boolean, validationCache?: EditorValidationCache): boolean | null;
