...
export declare function _filterChangedEdits(edits: EditMap): EditMap;
 ...
 */
export declare function _purgeUnchangedEdit(beans: BeanCollection, position: Required<EditPosition>, includeEditing?: boolean): void;
 ...
 */
export declare function _flushEditors(beans: BeanCollection): void;
/**
 ...
 */
export declare const _onPopupEditorClosed: (beans: BeanCollection, cellCtrl: CellCtrl, e?: MouseEvent | TouchEvent | KeyboardEvent) => void;
type SyncEditorParams = {
    persist?: boolean;
...
export declare const _collectEditorValidationCache: (beans: BeanCollection) => EditorValidationCache;
export declare const _syncFromEditors: (beans: BeanCollection, params: SyncEditorParams & {
    persist: boolean;
}, validationCache?: EditorValidationCache) => void;
/** The single-cell half of {@link _syncFromEditors}: stages one open editor's value into the model. */
export declare const _syncFromEditorComp: (beans: BeanCollection, position: Required<EditPosition>, params: SyncEditorParams & {
    persist: boolean;
}, validationCache?: EditorValidationCache) => void;
export declare function _syncFromEditor(beans: BeanCollection, position: Required<EditPosition>, editorValue?: any, params?: SyncEditorParams): void;
/** `edits` is explicit so that tearing down every open editor can never be the result of an omitted argument. */
export declare function _destroyEditors(beans: BeanCollection, edits: Required<EditPosition>[], params?: DestroyEditorParams, validationCache?: EditorValidationCache): void;
export type DestroyEditorParams = {
    event?: Event | null;
    silent?: boolean;
    cancel?: boolean;
};
export declare function _destroyEditor(beans: BeanCollection, position: Required<EditPosition>, params: DestroyEditorParams, cellCtrl?: CellCtrl | undefined, validationCache?: EditorValidationCache): void;
/** The uncached scan behind {@link EditService.editorsRequireValidation}, which owns the memo. */
export declare function _scanEditorsForValidation(beans: BeanCollection): boolean;
export declare function _populateModelValidationErrors(beans: BeanCollection, force?: boolean, validationCache?: EditorValidationCache): EditorValidationCache;
...
export declare const _populateRowValidationErrors: (beans: BeanCollection) => void;
...
export declare function _readEditValidationErrors(beans: BeanCollection): ICellEditorValidationError[] | null;
export {};
