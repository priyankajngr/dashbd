...
export declare class AgColumn<TValue = any> extends BeanStub<ColumnEventName> implements Column, IAgEventEmitter<ColumnEventName> {
    ...
    sortCycleIndex: number | undefined;
    ...
    isUserSized(): boolean;
    setUserSized(userSized: boolean): void;
    ...
    setHeaderNameOverride(headerName: string | null, source?: ColumnEventType): void;
...
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
export declare const _getAvailableSortTypes: (gos: GridOptionsService, column: AgColumn) => Set<SortType>;
...
export declare const _resolvePivotSortFromColDef: (colDef: ColDef) => SortDirection | undefined;
 ...
 *  @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
export declare const _defaultPivotSort: (beans: BeanCollection) => SortDirection;
/** A column's pivot sort with the unset default resolved via {@link _defaultPivotSort}.
 *  @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
export declare const _resolvePivotSort: (beans: BeanCollection, pivotSort: SortDirection | undefined) => SortDirection;
