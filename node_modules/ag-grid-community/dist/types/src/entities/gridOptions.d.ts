...
import type { DoesExternalFilterPass, FillOperation, FocusGridInnerElement, FullRowEditValidationParams, GetBusinessKeyForNode, GetChartMenuItemsParams, GetChartToolbarItemsParams, GetChildCount, GetColumnMenuItemsParams, GetContextMenuItemsParams, GetGroupAggFilteringParams, GetGroupIncludeFooterParams, GetGroupIncludeTotalRowParams, GetGroupRowAgg, GetLocaleText, GetMainMenuItemsParams, GetRowHeight, GetRowIdParams, GetServerSideGroupLevelParams, InitialGroupOrderComparator, IsApplyServerSideTransactionParams, IsExternalFilterPresent, IsFullWidthRow, IsGroupOpenByDefault, IsMasterOpenByDefault, IsServerSideGroupOpenByDefault, NavigateToNextCell, NavigateToNextHeader, PaginationNumberFormatter, PostProcessPopup, PostSortRows, ProcessDataFromClipboard, ProcessRowPostCreate, ProcessUnpinnedColumns, SendToClipboard, SetFillValueCallback, TabToNextCell, TabToNextGridContainer, TabToNextHeader } from '../interfaces/iCallbackParams';
...
export type GetColumnMenuItems<TData = any, TContext = any> = (params: GetColumnMenuItemsParams<TData, TContext>) => MenuCallbackReturn<DefaultColumnMenuItem, TData, TContext>;
...
export type PaginationPanelParams = PageSummaryPanelParams | PageSizePanelParams | RowSummaryPanelParams | PageNumbersPanelParams;
