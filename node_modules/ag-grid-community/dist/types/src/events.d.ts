...
export interface GridViewportWidthChangedEvent<TData = any, TContext = any> extends AgGlobalEvent<'gridViewportWidthChanged', TData, TContext> {
}
...
export interface ColumnHeaderNameChangedEvent<TData = any, TContext = any> extends ColumnEvent<'columnHeaderNameChanged', TData, TContext> {
    /**
