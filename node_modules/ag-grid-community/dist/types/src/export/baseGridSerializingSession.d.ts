...
import type { GridSerializingParams, GridSerializingSession, HeaderRowAccumulator, RowAccumulator } from './iGridSerializer';
...
export declare abstract class BaseGridSerializingSession<T> implements GridSerializingSession<T> {
    ...
    extractGroupHeaderValue(columnGroup: AgColumnGroup): string;
