...
export declare class ColumnFilterService extends BeanStub<'filterParamsChanged' | 'filterStateChanged' | 'filterAction' | 'filterGlobalButtons' | 'filterModelAsStringChanged'> implements NamedBean {
    beanName: BeanName;
