...
declare const FILTER_LOCALE_TEXT: {
    ...
    minDateInclusiveValidation: (variableValues: string[]) => string;
    maxDateInclusiveValidation: (variableValues: string[]) => string;
    strictMinValueValidation: (variableValues: string[]) => string;
    strictMaxValueValidation: (variableValues: string[]) => string;
    minValueValidation: (variableValues: string[]) => string;
    maxValueValidation: (variableValues: string[]) => string;
};
 ...
 */
export declare function isFilterLocaleTextKey(key: string): key is FilterLocaleTextKey;
/**
 ...
 */
export declare function translateFilterOptionKey(bean: {
...
export declare function translateForFilter(bean: {
    getLocaleTextFunc(): LocaleTextFunc;
}, key: FilterLocaleTextKey, variableValues?: string[]): string;
export {};
