...
export type ISimpleFilterModelPresetType = 'today' | 'yesterday' | 'tomorrow' | 'thisWeek' | 'lastWeek' | 'nextWeek' | 'thisMonth' | 'lastMonth' | 'nextMonth' | 'thisQuarter' | 'lastQuarter' | 'nextQuarter' | 'thisYear' | 'lastYear' | 'nextYear' | 'yearToDate' | 'last7Days' | 'last30Days' | 'last90Days' | 'last6Months' | 'last12Months' | 'last24Months';
/**
