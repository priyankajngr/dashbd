...
export declare const GRID_OPTION_DEFAULTS: {
    ...
    readonly loadingRows: false;
    readonly suppressPdfExport: false;
    ...
    readonly includeHiddenColumnsInCharts: true;
    ...
    readonly tabIndex: 0;
    readonly suppressInputClearButton: false;
    readonly enableInputAutoComplete: false;
    readonly rowBuffer: 10;
    readonly stickyRowsMaxViewportRatio: 0.5;
    ...
    readonly pivotPanelSuppressSort: false;
    ...
    readonly contentVisibilityAutoDelay: 1000;
