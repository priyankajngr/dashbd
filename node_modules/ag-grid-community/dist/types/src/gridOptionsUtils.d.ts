...
export declare function _isClientSideLoadingRows(gos: GridOptionsService): boolean;
export declare function _isClientSideLoadingRow(gos: GridOptionsService, rowNode: IRowNode): boolean;
export declare function _getClientSideLoadingRowCount(gos: GridOptionsService): number;
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
 ...
 * @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time.
 */
export declare function _canScrollVertically(beans: BeanCollection): boolean;
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
 ...
 */
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
export declare function _addRowHeightChangedListener(bean: BeanStub, onChange: () => void): void;
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
...
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
export declare function _getRowIdCallback<TData = any>(beans: BeanCollection): ((params: WithoutGridCommon<ExtractParamsFromCallback<GetRowIdFunc<TData>>>) => ExtractReturnTypeFromCallback<GetRowIdFunc<TData>>) | undefined;
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
 ...
 * @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time.
 */
export declare function _isHiddenSingleChildGroup(gos: GridOptionsService, node: RowNode): boolean;
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
