import type { CustomFilterOptionKey, ISimpleFilterModelPresetType, ISimpleFilterModelType } from '../filter/provided/iSimpleFilter';
...
export type ScalarAdvancedFilterModelType = 'equals' | 'notEqual' | 'lessThan' | 'lessThanOrEqual' | 'greaterThan' | 'greaterThanOrEqual' | 'inRange' | 'blank' | 'notBlank';
 ...
 */
export type AdvancedFilterOnlyOptionKey = Exclude<SetAdvancedFilterModelType | BooleanAdvancedFilterModelType, ISimpleFilterModelType>;
