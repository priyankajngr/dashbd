...
export interface SizeColumnsToFitGridStrategy<TData = any, TContext = any> extends DefaultWidthLimits, ContinuousAutoSizeOptions<TData, TContext> {
    type: 'fitGridWidth';
...
export interface SizeColumnsToFitProvidedWidthStrategy<TData = any, TContext = any> extends ContinuousAutoSizeOptions<TData, TContext> {
 ...
 */
export interface SizeColumnsToContentStrategy<TData = any, TContext = any> extends ISizeAllColumnsToContentParams, ContinuousAutoSizeOptions<TData, TContext> {
...
export type AutoSizeStrategy<TData = any, TContext = any> = SizeColumnsToFitGridStrategy<TData, TContext> | SizeColumnsToFitProvidedWidthStrategy<TData, TContext> | SizeColumnsToContentStrategy<TData, TContext>;
export {};
