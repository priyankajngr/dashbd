...
export interface PostProcessPopupParams<TData = any, TContext = any> extends AgGridCommon<TData, TContext> {
     ...
     * 'advancedFilterBuilder', 'advancedFilterBuilderSet', 'colorPicker', 'columnChooser', 'subMenu', 'tooltip'
     */
    type: string;
...
export type TabToNextGridContainer<TData = any, TContext = any> = (params: TabToNextGridContainerParams<TData, TContext>) => TabToNextGridContainerTarget | boolean | undefined;
...
export type IsMasterOpenByDefault<TData = any, TContext = any> = (params: IsMasterOpenByDefaultParams<TData, TContext>) => boolean;
