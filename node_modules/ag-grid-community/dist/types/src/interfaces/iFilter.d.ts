...
export type CreateFilterHandlerFunc<TData = any, TValue = any, TContext = any, TModel = any, TCustomParams = any> = (params: CreateFilterHandlerFuncParams<TData, TValue, TContext>) => FilterHandler<TData, TContext, TModel, TCustomParams>;
