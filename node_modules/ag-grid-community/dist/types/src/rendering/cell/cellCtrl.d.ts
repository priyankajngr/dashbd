...
import type { CellClassRules, CellStyle } from '../../entities/colDef';
...
export declare class CellCtrl extends BeanStub {
    ...
    value: any;
    valueFormatted: any;
    customStyleStaticClasses?: string[];
    customStyleClassRules?: CellClassRules;
    ...
    pendingEditStart: StartEditParams | null;
    ...
    rendererTooltipValue: string | undefined;
    rendererTooltipShouldDisplay: (() => boolean) | undefined;
    constructor(column: AgColumn, rowNode: RowNode, beans: BeanCollection, rowCtrl: RowCtrl);
    private isClientSideLoadingCell;
    private addFeatures;
    ...
    getCellRenderer(): ICellRenderer | null;
    destroy(): void;
    hasBrowserFocus(directOnly?: boolean): boolean;
