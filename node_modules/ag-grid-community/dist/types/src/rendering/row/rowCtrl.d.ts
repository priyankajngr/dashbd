...
export declare class RowCtrl extends BeanStub<RowCtrlEvent> {
    ...
    private readonly useTopPositioning;
    rowId: string | null;
    ...
    private isClientSideLoadingRow;
    ...
    getCellLane(cell: CellCtrl): ColumnPinnedType;
     ...
     */
    getFullWidthAnchorRole(): 'gridcell' | 'presentation';
