...
export type TooltipLocation = 'advancedFilter' | 'calculatedColumnAutocomplete' | 'calculatedColumnExpression' | 'cell' | 'cellEditor' | 'cellFormula' | 'columnToolPanelColumn' | 'columnToolPanelColumnGroup' | 'filterToolPanelColumnGroup' | 'filter' | 'fullWidthRow' | 'fullRowEditor' | 'header' | 'headerGroup' | 'listItem' | 'menu' | 'pivotColumnsList' | 'rowGroupColumnsList' | 'richSelectListItem' | 'richSelectValue' | 'select' | 'setFilterValue' | 'valueColumnsList' | 'UNKNOWN';
export interface TooltipCallbackParams<TData = any, TValue = any, TContext = any> extends AgGridCommon<TData, TContext> {
...
export type TooltipCallbackFunc<TData = any, TValue = any, TContext = any> = (params: TooltipCallbackParams<TData, TValue, TContext>) => any;
/**
 ...
 */
export type TooltipDefinition<TData = any, TValue = any, TContext = any> = boolean | string | TooltipCallbackFunc<TData, TValue, TContext>;
export interface ITooltipParams<TData = any, TValue = any, TContext = any> extends TooltipCallbackParams<TData, TValue, TContext> {
