...
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
export declare function _getCellTooltipComponentDefinition(colDef: ColDef | undefined): ColDef | undefined;
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
export declare function _getHeaderTooltipComponentDefinition(colDef: ColDef | ColGroupDef | null | undefined): ColDef | ColGroupDef | undefined;
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
...
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
export type TooltipFeature = AgTooltipFeature<BeanCollection, GridOptionsWithDefaults, AgEventTypeParams, AgGridCommon<any, any>, GridOptionsService, ITooltipParams, TooltipSourceParams, TooltipLocation>;
