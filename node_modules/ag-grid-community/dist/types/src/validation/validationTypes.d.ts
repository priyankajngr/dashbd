...
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
export declare function _createValidationWarning<TId extends ErrorId>(errorId: TId, params: GetErrorParams<TId>): ValidationWarning;
/**
 * As {@link _createValidationWarning}, but the diagnostic is captured as a deprecation (see {@link _deprecated}).
 */
export declare function _createDeprecationWarning<TId extends ErrorId>(errorId: TId, params: GetErrorParams<TId>): ValidationWarning;
/**
 ...
 * @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time.
 */
export declare function _emitValidationWarning(warning: string | ValidationWarning, log: LogService): void;
