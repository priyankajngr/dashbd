import type { BaseCellEditor, BaseDate, BaseDateParams, BaseFilter, BaseFilterParams, BaseFloatingFilter, BaseMenuItem, BaseMenuItemParams, BaseToolPanelParams, FilterDisplayParams, FloatingFilterDisplayParams, ICellEditorParams, ICellRendererParams, IColumnSelectionLabelRendererParams, IDetailCellRendererParams, IDragAndDropImageParams, IExportingOverlayParams, IFilter, IFloatingFilterParams, IGroupCellRendererParams, IHeaderGroupParams, IHeaderParams, ILoadingCellRendererParams, ILoadingOverlayParams, INoMatchingRowsOverlayParams, INoRowsOverlayParams, IOverlayParams, IStatusPanelParams, ITooltipParams, SharedFilterUi } from 'ag-grid-community';
...
export interface CustomExportingOverlayProps<TData = any, TContext = any> extends IExportingOverlayParams<TData, TContext> {
}
...
export interface CustomNoMatchingRowsOverlayProps<TData = any, TContext = any> extends INoMatchingRowsOverlayParams<TData, TContext> {
}
...
export interface CustomColumnSelectionLabelProps<TData = any, TContext = any> extends IColumnSelectionLabelRendererParams<TData, TContext> {
}
