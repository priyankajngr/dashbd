...
export declare const FOCUSABLE_EXCLUDE = "[disabled], .ag-disabled:not(.ag-button), .ag-disabled *, .ag-hidden, .ag-hidden *";
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
...
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
export declare function _observeIntersection(beans: UtilBeanCollection, element: HTMLElement, callback: (entry: IntersectionObserverEntry) => void, options?: IntersectionObserverInit): () => void;
/** @internal AG_GRID_INTERNAL - Not for public use. Can change / be removed at any time. */
